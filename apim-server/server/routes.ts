...
export default function routes(app: Application, apiBase: string): void {
  ...
  // Public Routes
  app.post(`${apiBase}/apsSession/login`, passport.authenticate(APSAuthStrategyService.getApsStrategyName()), ApsSessionController.login);
  ...
  // sessions
  router.use('/apsSession', apsSessionRouter);
  // System Admin routes
