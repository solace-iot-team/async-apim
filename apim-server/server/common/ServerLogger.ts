...
export enum EServerStatusCodes {
  ...
  CONFIG_TEST_ERROR = "CONFIG_TEST_ERROR",

  ACTIVE_CONNECTOR_TESTING = "ACTIVE_CONNECTOR_TESTING",
  ACTIVE_CONNECTOR_TESTED = "ACTIVE_CONNECTOR_TESTED",
  ACTIVE_CONNECTOR_TEST_ERROR = "ACTIVE_CONNECTOR_TEST_ERROR",
  ACTIVE_CONNECTOR_UPDATE = "ACTIVE_CONNECTOR_UPDATE",
  ACTIVE_CONNECTOR_TEST_NO_ACTIVE_CONNECTOR_DEFINED = "ACTIVE_CONNECTOR_TEST_NO_ACTIVE_CONNECTOR_DEFINED",
