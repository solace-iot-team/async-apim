...
export interface IEditNewSystemUserAuthenticationProps {
  action: EAction,
  apSystemUserDisplay: TAPSystemUserDisplay;
  onSave: (apUserAuthenticationDisplay: TAPUserAuthenticationDisplay) => void;
  onCancel: () => void;
  onError: (apiCallState: TApiCallState) => void;
  onBack: () => void;
}

export const EditNewSystemUserAuthentication: React.FC<IEditNewSystemUserAuthenticationProps> = (props: IEditNewSystemUserAuthenticationProps) => {
  const ComponentName = 'EditNewSystemUserAuthentication';
  ...
  const doInitialize = async () => {
    setManagedObject(APSystemUsersDisplayService.get_ApUserAuthenticationDisplay({
