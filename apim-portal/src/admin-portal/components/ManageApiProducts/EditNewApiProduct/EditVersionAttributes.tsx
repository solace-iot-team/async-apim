...
export interface IEditVersionAttributesProps {
...
export const EditVersionAttributes: React.FC<IEditVersionAttributesProps> = (props: IEditVersionAttributesProps) => {
  const ComponentName = 'EditVersionAttributes';
  ...
  const apiUpdateManagedObject = async(mo: TManagedObject): Promise<TApiCallState> => {
    ...
    try {
      await APAdminPortalApiProductsDisplayService.apiUpdate_ApApiProductDisplay_Version_Attributes({
