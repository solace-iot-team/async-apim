...
export const EditPolicies: React.FC<IEditPoliciesProps> = (props: IEditPoliciesProps) => {
  ...
  const apiUpdateManagedObject = async(mo: TManagedObject): Promise<TApiCallState> => {
    ...
    try {
      await APAdminPortalApiProductsDisplayService.apiUpdate_ApApiProductDisplay({
        ...
        apApiProductDisplay: APAdminPortalApiProductsDisplayService.set_ApApiProductDisplay_Policies({
  ...
  const doInitialize = async () => {
    setManagedObject(APAdminPortalApiProductsDisplayService.get_ApApiProductDisplay_Policies({ apApiProductDisplay: props.apAdminPortalApiProductDisplay }));
  }
