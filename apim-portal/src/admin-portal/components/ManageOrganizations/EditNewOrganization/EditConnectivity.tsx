...
import APSingleOrganizationDisplayService, { 
  ...
  IAPSingleOrganizationDisplay_Connectivity, 
...
export interface IEditConnectivityProps {
...
export const EditConnectivity: React.FC<IEditConnectivityProps> = (props: IEditConnectivityProps) => {
  const ComponentName = 'EditConnectivity';
    ...
    try {
      switch(type) {
        case E_ManageOrganizations_Scope.SYSTEM_ORGS:
          await APSystemOrganizationsDisplayService.apiUpdate_ApOrganizationDisplay_Connectivity({ 
            apOrganizationDisplay_Connectivity: mo
          });
          break;
        case E_ManageOrganizations_Scope.ORG_SETTINGS:
          await APSingleOrganizationDisplayService.apiUpdate_ApOrganizationDisplay_Connectivity({ 
            apOrganizationDisplay_Connectivity: mo
          });
          break;
  ...
  const doInitialize = async () => {
    ...
    switch(type) {
      case E_ManageOrganizations_Scope.SYSTEM_ORGS:
        ...
        break;
      case E_ManageOrganizations_Scope.ORG_SETTINGS:
        setManagedObject(APSingleOrganizationDisplayService.get_ApOrganizationDisplay_Connectivity({
          apOrganizationDisplay: props.apOrganizationDisplay
        }));
        break;
      case E_ManageOrganizations_Scope.ORG_STATUS:
