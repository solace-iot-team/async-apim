...
export interface IEditUserSettingsProps {
...
export const EditUserSettings: React.FC<IEditUserSettingsProps> = (props: IEditUserSettingsProps) => {
  // const componentName = 'EditUserSettings';
  ...
  const _TODO: boolean = true;
  
  const renderManagedObjectForm = () => {
    // const funcName = 'renderManagedObjectForm';
    // const logName = `${componentName}.${funcName}()`;
    if(_TODO) return renderTodo();
    else 
    return (
      <div className="card">
  ...
  const renderTodo = () => {
    return (
      <div>
        <p>TODO: user specific settings </p>
        <ul>
          <li>
            select default org at login vs. select org at login?
          </li>
        </ul>
      </div>
    )
  ...
  return (
    <div className="manage-user-account">
      ...
      { ManageUserAccountCommon.renderSubComponentHeader(`Edit Settings:`) }
