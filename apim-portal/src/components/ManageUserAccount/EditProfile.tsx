...
export const EditProfile: React.FC<IEditProfileProps> = (props: IEditProfileProps) => {
  ...
  const create_ManagedObject_From_FormEntities = ({orginalManagedObject, formDataEnvelope}: {
    ...
    mo.first = fd.first;
    mo.last = fd.last;
    mo.apEntityId.displayName = APLoginUsersDisplayService.create_UserDisplayName(mo);
    return mo;
  }
  ...
  const apiUpdateManagedObject = async(mo: TManagedObject): Promise<TApiCallState> => {
    ...
    try {
      await APLoginUsersDisplayService.apsUpdate_ApUserProfileDisplay({
  ...
  const doInitialize = async () => {
    setManagedObject(APLoginUsersDisplayService.get_ApUserProfileDisplay({
