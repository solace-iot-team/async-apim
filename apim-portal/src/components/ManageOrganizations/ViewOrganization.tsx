...
import { ManageConnectorsCommon } from "../ManageConnectors/ManageConnectorsCommon";
...
export const ViewOrganization: React.FC<IViewOrganizationProps> = (props: IViewOrganizationProps) => {
  ...
  return (
    <div className="manage-users">
      ...
      {ManageConnectorsCommon.renderSubComponentHeader(`Organization: ${props.organizationDisplayName}`)}
