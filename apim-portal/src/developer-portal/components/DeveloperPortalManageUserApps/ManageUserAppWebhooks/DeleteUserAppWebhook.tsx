...
export interface IDeleteUserAppWebhookProps {
...
export const DeleteUserAppWebhook: React.FC<IDeleteUserAppWebhookProps> = (props: IDeleteUserAppWebhookProps) => {
  const ComponentName = 'DeleteUserAppWebhook';
