...
import { EAction } from "../DeveloperPortalManageUserAppsCommon";
import { TAPDeveloperPortalUserAppDisplay } from "../../../displayServices/APDeveloperPortalUserAppsDisplayService";

import '../../../../components/APComponents.css';
import "../DeveloperPortalManageUserApps.css";

export interface IDeveloperPortalEditNewUserAppFormProps {
  formId: string;
  action: EAction;
  organizationId: string;
  apDeveloperPortalUserAppDisplay: TAPDeveloperPortalUserAppDisplay;
  onSubmit: (apDeveloperPortalUserAppDisplay: TAPDeveloperPortalUserAppDisplay) => void;
  onError: (apiCallState: TApiCallState) => void;
  onLoadingChange: (isLoading: boolean) => void;
}


export const DeveloperPortalEditNewUserAppForm: React.FC<IDeveloperPortalEditNewUserAppFormProps> = (props: IDeveloperPortalEditNewUserAppFormProps) => {
  const ComponentName = 'DeveloperPortalEditNewUserAppForm';
  ...
  const doInitialize = async () => {
    setManagedObject(props.apDeveloperPortalUserAppDisplay);
  }
    ...
    return (
      <div className="card p-mt-4">
        <div className="p-fluid">
          ...
          <div className="p-text-bold p-mb-3">TODO: render the form here</div>
