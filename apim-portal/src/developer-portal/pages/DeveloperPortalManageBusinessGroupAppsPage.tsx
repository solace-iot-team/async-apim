...
import { DeveloperPortalManageTeamApps } from '../components/DeveloperPortalManageApps/DeveloperPortalManageTeamApps/DeveloperPortalManageTeamApps';

import "../../pages/Pages.css";

export const DeveloperPortalManageBusinessGroupAppsPage: React.FC = () => {
  const componentName = "DeveloperPortalManageBusinessGroupAppsPage";
